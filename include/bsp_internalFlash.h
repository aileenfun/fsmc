...
#define FPGA_VER_SECTOR ADDR_FLASH_SECTOR_10 
#define FPGA_VER_SECTOR_END ADDR_FLASH_SECTOR_11

#define F_AMP_SN_SECTOR ADDR_FLASH_SECTOR_9
#define F_AMP_SN_SECTOR_END ADDR_FLASH_SECTOR_10
//AMP_SN cmd0,1,2,3,cmd1,4,5,6,pre_max_chn_num
